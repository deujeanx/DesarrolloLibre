...
<div class="min-h-screen bg-gray-100 py-10">
    <div class="max-w-6xl mx-auto px-6">
        ...
        {{-- 🔹 Filtros --}}
        <div class="bg-white shadow-md rounded-xl p-6 mb-8 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
        ...
        <div id="flightsContainer" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach ($flights as $flight)
                @php
                    $dateOnly = $flight->dateHour;
                @endphp
                <div
                    class="flightCard bg-white rounded-2xl shadow-md hover:shadow-lg transition duration-200 overflow-hidden"
                ...
                >
                    <div class="p-5">
                        ...
                        <p class="text-gray-600 text-sm mb-1">
                            <strong>Modelo avión:</strong> {{ $flight->model_plane->marca }} ({{ $flight->model_plane->capacidad }} asientos)
                        </p>
                        <p class="text-gray-600 text-sm mb-1">
                            <strong>Precio por asiento:</strong> ${{ number_format($flight->positionValue, 0, ',', '.') }}
                        </p>
